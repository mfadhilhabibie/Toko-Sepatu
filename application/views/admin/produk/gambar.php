...
<div class="col-md-5">
    <button class="btn btn-success btn-lg" name="submit" type="submit">
        <i class="fa fa-save"></i> Save and Upload Image
    </button>
...
<table class="table table-bordered" id="example1">
    ...
    <tbody>
        ...
        <tr>
            ...
            <a href="<?php echo base_url('admin/produk/delete_gambar/'.$produk->id_produk.'/'.$gambar->id_gambar) ?>" class="btn btn-danger btn-xs" onclick="return confirm('Yakin mau hapus gambar ini ?')"><i class="fa fa-trash-o"></i> Delete</a>
