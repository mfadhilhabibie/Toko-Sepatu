...
<table class="table table-bordered" id="example1">
    ...
    <tbody>
        ...
        <tr>
            ...
            <a href="<?php echo base_url('admin/kategori/delete/'.$kategori->id_kategori) ?>" class="btn btn-danger btn-xs" onclick="return confirm('Yakin mau apus data ini??')"><i class="fa fa-trash-o"></i> Hapus</a>
            </td>
        </tr>
        <?php $no++; } ?>
    </tbody>  
