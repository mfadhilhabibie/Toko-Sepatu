					...
					<!-- MENU PRODUK -->
						<li>
							...
							<ul class="sub_menu">
								...
								<li><a href="<?php echo base_url('produk/kategori/'.$nav_produk->slug_kategori ) ?>"> <?php echo $nav_produk->nama_kategori ?> </a></li> <?php } ?>
							</ul>
						</li>
			...
			<ul class="main-menu">
				...
				<li class="item-menu-mobile">
					...
					<ul class="sub-menu">
						...
						<li><a href="<?php echo base_url('produk/kategori/'.$nav_produk_mobile->slug_kategori ) ?>"> <?php echo $nav_produk_mobile->nama_kategori ?> </a></li> <?php } ?>
					</ul>
				...
				<!-- menu konatk mobile -->
				<li class="item-menu-mobile">
					<a href="<?php echo base_url('kantak') ?>">Contact</a>
				</li>
			</ul>
		</nav>
	</div>
